...
class ReplayMemory(object):
    """
    Replay Memory
    Stores transition in a cyclic buffer
    """

    def __init__(self, capacity):
        """
        Initializes replay memory
        :param capacity: size of cyclic buffer
        """
...
# Reset environment
env.reset()
plot_screen(get_screen(), 'Example extracted screen')
