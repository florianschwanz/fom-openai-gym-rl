...
if RUN_TO_LOAD != None:
 ...
 \
    ...
    REWARD_BREAKOUT_PLAYER_RACKET_CLOSE_TO_BALL_LINEAR = float(os.getenv('REWARD_BREAKOUT_PLAYER_RACKET_CLOSE_TO_BALL_LINEAR', 0.5))
    ...
    REWARD_BREAKOUT_BALL_HITTING_UPPER_BLOCK = float(os.getenv('REWARD_BREAKOUT_BALL_HITTING_UPPER_BLOCK', 6.0))
